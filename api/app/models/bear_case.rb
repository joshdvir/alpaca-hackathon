...
# Indexes
#
#  index_bear_cases_on_agent_run_id           (agent_run_id)
#  index_bear_cases_on_ticker_and_created_at  (ticker,created_at)
#
# Foreign Keys
#
#  fk_rails_...  (agent_run_id => agent_runs.id)
#
class BearCase < ApplicationRecord
